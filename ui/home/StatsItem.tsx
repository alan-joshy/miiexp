...
const StatsItem = ({ icon, title, value, className,titleColor, tooltipLabel, url, isLoading }: Props) => {
...
>
  <span style={{ color: titleColor }}>{title}</span>
        ...
        <Skeleton isLoaded={ !isLoading } fontWeight={ 500 } fontSize="md" color={ useColorModeValue('white', 'white') } borderRadius="base">
          <span>{ value }</span>
        </Skeleton>
      </Flex>
